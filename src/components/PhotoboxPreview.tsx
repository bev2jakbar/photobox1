...
export default function PhotoboxPreview({
  ...
  const isCustomTemplateFrame = activeFrame.id === 'tts1' || activeFrame.id === 'tts2' || activeFrame.id === 'tts3' || activeFrame.id === 'gummyberry' || activeFrame.id === 'strawberry' || activeFrame.id === 'popice_candy' || activeFrame.id === 'etawa' || activeFrame.id === 'nutrijell';
          ...
          >
            ...
            >
              {currentPhotos.map((photo, i) => (
                <label
                  key={i}
                  className={`group relative rounded-xl overflow-hidden bg-zinc-900 transition-all duration-300 w-full h-full cursor-pointer flex ${
